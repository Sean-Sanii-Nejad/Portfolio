...
const Navbar = () => {
    ...
    <div className='navbar' >
      ...
      <ul className="nav-menu">
        ...
        <li><AnchorLink className="anchor-link" offset={100} href="#aboutme"><p className={activeTab === 1 ? 'active-tab' : ''}onClick={() => handleTabClick(1)}>About Me</p></AnchorLink></li>
        <li><AnchorLink className="anchor-link" offset={80} href="#demo"><p className={activeTab === 2 ? 'active-tab' : ''}onClick={() => handleTabClick(2)}>Demo</p></AnchorLink></li>
        <li><AnchorLink className="anchor-link" offset={90} href="#portfoliox"><p id="aboutmes" className={activeTab === 3 ? 'active-tab' : ''}onClick={() => handleTabClick(3)}>Portfolio</p></AnchorLink></li>
